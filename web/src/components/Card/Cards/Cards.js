        ...
        <tbody>
          {cards.map((card) => (
            <tr key={card.id}>
              ...
              <td>{truncate(card.setName)}</td>
              <td>{truncate(card.startingFromPrice)}</td>
              <td>{truncate(card.cardImage)}</td>
              <td>{truncate(card.color)}</td>
              <td>{truncate(card.cardType)}</td>
              <td>{truncate(card.manaValue)}</td>
              <td>
